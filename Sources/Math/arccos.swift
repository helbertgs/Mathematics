...
@inline(__always)
fileprivate let pi =  3.14159265358979311600e+00

/// 0x3FF921FB, 0x5444D18, 1.570796326794896558
@inline(__always)
fileprivate let pio2_hi =  1.57079632679489655800e+00

/// 0x3C91A626, 0x3314C07, 6.123233995736766036e-17
@inline(__always)
fileprivate let pio2_lo =  6.12323399573676603587e-17

/// 0x3FC55555, 0x55555555, 0.1666666666666666574
@inline(__always)
fileprivate let pS0 =  1.66666666666666657415e-01

/// 0xBFD4D612, 0x03EB6F7D, 0.3255658186224009154
@inline(__always)
fileprivate let pS1 = -3.25565818622400915405e-01

/// 0x3FC9C155, 0x0E884455, 0.3255658186224009154
@inline(__always)
fileprivate let pS2 =  2.01212532134862925881e-01

/// 0xBFA48228, 0xB5688F3B, 0.0400555345006794114
@inline(__always)
fileprivate let pS3 = -4.00555345006794114027e-02

/// 0x3F49EFE0, 0x7501B288, 0.0007915349942898145322
@inline(__always)
fileprivate let pS4 =  7.91534994289814532176e-04

/// 0x3F023DE1, 0x0DFDF709, 3.479331075960211676e-05
@inline(__always)
fileprivate let pS5 =  3.47933107596021167570e-05

/// 0xC0033A27, 0x1C8A2D4B, 2.403394911734414219
@inline(__always)
fileprivate let qS1 = -2.40339491173441421878e+00

/// 0x40002AE5, 0x9C598AC8, 2.403394911734414219
@inline(__always)
fileprivate let qS2 =  2.02094576023350569471e+00

/// 0xBFE6066C, 0x1B8D0159, 0.688283971605453293
@inline(__always)
fileprivate let qS3 = -6.88283971605453293030e-01

/// 0x3FB3B8C5, 0xB12E9282, 0.07703815055590193528
@inline(__always)
fileprivate let qS4 =  7.70381505559019352791e-02
